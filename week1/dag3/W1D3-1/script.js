...
let selectedColors = ["rood", "blauw", "geel"];
...
var removedColors = selectedColors.indexOf("groen");

console.log(removedColors);
selectedColors.splice(removedColors, 1);
console.log("Deze heb je zojuist verwijderd: " + removedColors);
